...
<div class="container">
    ...
    <ul class="">
			...
			<li><a href="registration.php" class="<?php echo ($_SERVER['PHP_SELF'] == "/VDKproject/categories/registration.php" ? "active" : "");?>">Create User</a></li>
			<li><a href="#" class="">Search User</a></li>
	</ul>
    </div>