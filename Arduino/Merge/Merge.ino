...
void ServoClose() // opens the servo
{
...
void ServoOpen() // closes the servo
{
    ...
    case '0':
      {
        ...
        while (x == '0')
        {
          ...
          {
            x = '2';
            hienthi_clear(0, 0, "Please press FP");
           // hienthi(1, 0, "Processing...");
            inputFingerprint();
            break;
          }
        }
